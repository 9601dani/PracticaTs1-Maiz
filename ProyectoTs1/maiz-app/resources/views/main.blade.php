...
<div class="contenedor" >
        ...
        <img src="https://external-content.duckduckgo.com/iu/?u=http%3A%2F%2Fciclodevida.net%2Fwp-content%2Fuploads%2F2019%2F02%2Fciclo-de-vida-del-maiz.jpg&f=1&nofb=1&ipt=6740c539841861f4789417b5241ee8c253317c003c05f4eacd7dcecd0f01eb07&ipo=images"
         ...
         <div>
            ...
            <b>Preparación del suelo:</b> se limpia y se ara el terreno para prepararlo para la siembra. <br>
            <b>Siembra: </b>se realiza la siembra de las semillas de maíz en el suelo preparado. En Guatemala, se siembra principalmente en la época de lluvia (de mayo a octubre). <br>
            <b>Cuidado de los cultivos: </b>durante el crecimiento del maíz, se debe controlar el crecimiento de malezas, plagas y enfermedades. También es importante monitorear el riego y la nutrición de los cultivos. <br>
            <b>Cosecha:</b> una vez que las mazorcas de maíz han madurado, se cosechan a mano y se retiran las hojas exteriores. En Guatemala, la cosecha de maíz generalmente ocurre entre los meses de septiembre y noviembre. <br>
            <b>Almacenamiento:</b> el maíz se puede almacenar en bodegas secas y ventiladas hasta que se necesite para su uso o venta. <br>
            <b>Comercialización:</b> el maíz se puede vender a los mercados locales o exportarse a otros países. En Guatemala, el maíz es un cultivo importante para la alimentación humana y animal, y es una importante fuente de ingresos para los agricultores. <br>
            </div>
         </div>
        </div>
        <div class="columna1">
            ...
            tamaño de las hojas y la raigambre. Una producción temprana de follaje también afecta
             ...
             disponibles en el momento oportuno, o un desarrollo pobre restringirá el crecimiento. La etapa más crítica referente a la nutrición, es V6
            </div>
        </div>
